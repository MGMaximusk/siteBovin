...
<html lang="en">
	...
	<?php
					...
					if(isset($code_boucle)){
						...
						$sql = "SELECT * FROM bovin INNER JOIN agriculteur ON (id_agriculteur_bovin = id_agriculteur) INNER JOIN abattoir ON (nom_abat_bovin = nom_abat) WHERE code_boucle LIKE ('%$code_boucle%')";
